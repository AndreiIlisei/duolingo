...
ALTER TABLE "user_progress" ADD CONSTRAINT "user_progress_active_learning_path_id_learning_paths_id_fk" FOREIGN KEY ("active_learning_path_id") REFERENCES "public"."learning_paths"("id") ON DELETE cascade ON UPDATE no action;